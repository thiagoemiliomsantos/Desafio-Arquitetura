...
/// <summary>Extensões de health check para o serviço de consolidado.</summary>
public static class HealthExtensions
{
    ...
    public static IServiceCollection AddServiceHealthChecks(this IServiceCollection services)
    {
        services.AddHealthChecks()
            ...
            .AddCheck<ConsolidationDbHealthCheck>("database", tags: ["ready"]);
        return services;
    }
...
/// <summary>Verifica a conectividade com o banco de dados do ConsolidationService.</summary>
file sealed class ConsolidationDbHealthCheck(IServiceScopeFactory scopeFactory) : IHealthCheck
{
